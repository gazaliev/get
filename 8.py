...
axes.grid(color = "green", which = "both", linestyle = ':', linewidth = 0.5)
...
axes.text(x = (charge_time/2-0.8), y = volt_max/2, s = ("Charge time: " + str(round(charge_time, 2)) + " s"), color = 'green', fontsize = 14)
